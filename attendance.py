...
class Attendance:
    def __init__(self,root):
        ...
        #first imag
        img=Image.open(r"college_images\student.webp")
        ...
        img1=Image.open(r"college_images\photos.jpg" )
        ...
        #bg image
        img3=Image.open(r"C:\Users\priya\OneDrive\Desktop\face_recognition_system\college_images\Bg1.jpg")
        ...
        atten_roll=ttk.Entry(left_inside_frame,width=20,command=self.var_atten_roll,font=("comicsansns 11 bold"))
        ...
        atten_name=ttk.Entry(left_inside_frame,width=20,command=self.var_atten_name,font=("comicsansns 11 bold"))
        atten_name.grid(row=1,column=1,pady=15)
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=20,command=self.var_atten_dep,font=("comicsansns 11 bold"))
        ...
        atten_time=ttk.Entry(left_inside_frame,width=20,command=self.var_atten_time,font=("comicsansns 11 bold"))
        ...
        atten_date=ttk.Entry(left_inside_frame,width=20,command=self.var_atten_date,font=("comicsansns 11 bold"))
        ...
        self.atten_status=ttk.Combobox(left_inside_frame,width=20,command=self.var_atten_attendance,font="comicsansns 11 bold",state="readonly" )
