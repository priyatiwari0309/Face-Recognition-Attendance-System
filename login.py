...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\priya\Desktop\face_recognition_system\college_images\login.jpg")
        ...
        img1=Image.open(r"C:\Users\priya\Desktop\face_recognition_system\college_images\login-security.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username='root', password='rootpw',host='localhost',database='face_recognition',port=3307)
