...
class Face_Recognition:
    def __init__(self,root):
        ...
        img_top=Image.open(r"college_images\istockphoto.jpg")
        ...
        img_bottom=Image.open(r"college_images\face detect.webp")
        ...
        b1_1=Button(f_lb1,text="Face Recognition",cursor="hand2",font=("times new roman",18,"bold"),bg="dark green",fg="white")
    ...
    def face_recog(self):
        def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for(x,y,w,h)in features:
                ...
                conn=mysql.connector.connect(host="localhost",database="face_recognizer",username="root",password="rootpw")
